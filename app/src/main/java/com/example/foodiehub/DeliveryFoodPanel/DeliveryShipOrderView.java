...
public class DeliveryShipOrderView extends AppCompatActivity {
    ...
    private void deliveryfinalorders() {
        ...
        reference = FirebaseDatabase.getInstance().getReference("DeliveryShipFinalOrders").child(Objects.requireNonNull(FirebaseAuth.getInstance().getCurrentUser()).getUid()).child(RandomUID).child("Dishes");
